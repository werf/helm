...
import hapi_release7 "k8s.io/helm/pkg/proto/hapi/release"
...
type InstallReleaseResponse struct {
	Release  *hapi_release5.Release  `protobuf:"bytes,1,opt,name=release" json:"release,omitempty"`
	LogChunk *hapi_release7.LogChunk `protobuf:"bytes,2,opt,name=log_chunk,json=logChunk" json:"log_chunk,omitempty"`
}
...
func (m *InstallReleaseResponse) GetLogChunk() *hapi_release7.LogChunk {
	if m != nil {
		return m.LogChunk
	}
	return nil
...
var fileDescriptor0 = []byte{
	...
	,
}
